			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="<?php echo e(route('login')); ?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="email" name="email" placeholder="Email" id="email" value="<?php echo e(old('email')); ?>" required autofocus>
...
</html><?php /**PATH C:\xampp\htdocs\project\DragonFruit\resources\views/auth/login.blade.php ENDPATH**/ ?>